...
import { FaListAlt, FaSave, FaTimes, FaSearch, FaEdit, FaTrashAlt } from 'react-icons/fa';
...
function CriarAtivSust() {
    ...
    const handleEditar = (atividade) => {
        setAtividade({
            ...
            tipoAtividade: { id: atividade.tipoAtividade.id, nome: atividade.tipoAtividade.nome },
                                ...
                                <tbody>
                                    {listaAtividades.map((atividade) => (
                                        <tr key={atividade.criar_id}>
                                            ...
                                            <td colSpan={2} className='text-center'>
                                                <Button variant="link" className="text-danger text" onClick={() => handleExcluir(atividade.id)}>
                                                    <FaTrashAlt />
                                                </Button>
                                            </td>
                                        </tr>
